...
(function ()
{
    ...
    RegisterController.$inject = ["msApi", "$location"];
    angular
        .module('app.pages.auth.register')
...
(function ()
{
    ...
    LoginController.$inject = ["msApi", "$location"];
    angular
        .module('app.pages.auth.login')
    ...
    function config($stateProvider, $translatePartialLoaderProvider, msApiProvider, msNavigationServiceProvider)
    {
        ...
        $stateProvider
            .state('app.activity', {
                ...
                resolve: {
                    ActivityData: ["msApi", function (msApi)
                    {
        ...
        // Api
        msApiProvider.register('activity', ['/activities.json']);
...
(function ()
{
    ...
    ActivityController.$inject = ["ActivityData"];
    angular
        .module('app.activity')
